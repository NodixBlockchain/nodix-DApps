...
#  define png_strcpy  strcpy_cs
#  define png_strncpy strncpy_c     /* Added to v 1.2.6 */
#  define png_strlen  strlen_c
#  define png_memcmp  memcmp_c      /* SJT: added */
#  define png_memcpy  memcpy_c
#  define png_memset(x,a,y)  memset_c(x,0,y)
#endif
