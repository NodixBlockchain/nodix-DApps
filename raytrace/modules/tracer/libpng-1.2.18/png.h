...
#define PNG_COLOR_DIST(c1, c2) (iabs_c((int)((c1).red) - (int)((c2).red)) + \
   iabs_c((int)((c1).green) - (int)((c2).green)) + \
   iabs_c((int)((c1).blue) - (int)((c2).blue)))
...
//#include <base/std_math.h>
//#include "../engine/zdm_math.h"
